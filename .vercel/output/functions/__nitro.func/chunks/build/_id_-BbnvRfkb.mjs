...
import { ref, computed, reactive, mergeProps, withCtx, createVNode, resolveDynamicComponent, unref, createBlock, openBlock, withModifiers, createCommentVNode, withDirectives, vModelText, Fragment, renderList, toDisplayString, vModelSelect, createTextVNode, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList, ssrRenderClass, ssrRenderVNode } from 'vue/server-renderer';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const handleSubmit = async () => {
      ...
      try {
        console.log("\u{1F504} Editar Cultivo: Guardando cambios...");
        const updateData = {
          name: formData.name,
        ...
        toast.success(`\xA1Cultivo "${result.data.name}" actualizado exitosamente!`);
        ...
        toast.error(((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || "Error al actualizar el cultivo");
      } finally {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-8" }, _attrs))}><div class="mb-8"><h1 class="text-3xl font-bold text-white"> Editar Cultivo: ${ssrInterpolate(((_a = crop.value) == null ? void 0 : _a.name) || "Cargando...")}</h1><p class="text-gray-400 text-lg"> Modifica la configuraci\xF3n del cultivo seleccionado </p></div>`);
      if (!crop.value && !isLoading.value) {
        _push(`<div class="bg-red-900/20 border border-red-500/30 rounded-lg p-6"><div class="flex items-center"><svg class="w-6 h-6 text-red-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z"></path></svg><div><h3 class="text-lg font-medium text-red-400">Cultivo no encontrado</h3><p class="text-red-300 mt-1">El cultivo con ID ${ssrInterpolate(_ctx.$route.params.id)} no existe.</p></div></div></div>`);
      } else if (crop.value) {
            ...
            if (_push2) {
              ...
              _push2(ssrRenderComponent(_component_nuxt_link, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="flex items-center space-x-2"${_scopeId2}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"${_scopeId2}></path></svg><span${_scopeId2}>Volver</span></div>`);
                  } else {
                    return [
              ...
              _push2(`<div class="flex space-x-3"${_scopeId}><button type="button" class="px-6 py-3 text-yellow-400 hover:text-yellow-300 border border-yellow-500/30 hover:border-yellow-400/50 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-yellow-500"${_scopeId}> Restablecer </button><button type="submit"${ssrIncludeBooleanAttr(isSubmitting.value || validationErrors.value.length > 0) ? " disabled" : ""} class="px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold rounded-lg shadow-lg hover:from-green-600 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 transform hover:scale-105"${_scopeId}>`);
              if (isSubmitting.value) {
                _push2(`<span class="flex items-center"${_scopeId}><svg class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" fill="none" viewBox="0 0 24 24"${_scopeId}><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"${_scopeId}></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"${_scopeId}></path></svg> Guardando... </span>`);
              } else {
                _push2(`<span class="flex items-center"${_scopeId}><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"${_scopeId}></path></svg> Guardar Cambios </span>`);
              }
                ...
                createVNode("form", {
                  ...
                  createVNode("div", { class: "space-y-4" }, [
                    ...
                    createVNode("div", null, [
                      ...
                      withDirectives(createVNode("textarea", {
                        ...
                        placeholder: "Descripci\xF3n del cultivo..."
                      }, null, 8, ["onUpdate:modelValue"]), [
                  ...
                  createVNode("div", { class: "space-y-4" }, [
                    ...
                    createVNode("div", null, [
                        ...
                        createVNode("div", {
                          ...
                          imagePreview.value ? (openBlock(), createBlock("div", {
                            ...
                            createVNode("p", { class: "mt-2 text-sm text-gray-400 group-hover:text-gray-300 transition-colors" }, [
                              createVNode("span", { class: "font-medium" }, "Haz clic para cambiar"),
                      ...
                      createVNode("p", { class: "mt-2 text-xs text-gray-400" }, " Imagen actual del cultivo. Puedes cambiarla seleccionando una nueva. ")
                    ])
                  ]),
        ...
        _push(ssrRenderComponent(BaseCard, { title: "Informaci\xF3n del Sistema" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="space-y-4"${_scopeId}><div${_scopeId}><h4 class="text-sm font-medium text-white mb-3"${_scopeId}>Estado Actual</h4><div class="space-y-2"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><span class="text-sm text-gray-400"${_scopeId}>Seleccionado:</span><span class="${ssrRenderClass(crop.value.isSelected ? "text-green-400" : "text-gray-400")}"${_scopeId}>${ssrInterpolate(crop.value.isSelected ? "S\xED" : "No")}</span></div><div class="flex items-center justify-between"${_scopeId}><span class="text-sm text-gray-400"${_scopeId}>Bomba de agua:</span><span class="${ssrRenderClass(crop.value.waterPumpActive ? "text-blue-400" : "text-gray-400")}"${_scopeId}>${ssrInterpolate(crop.value.waterPumpActive ? "Activa" : "Inactiva")}</span></div></div></div><div class="border-t border-gray-600 pt-4"${_scopeId}><h4 class="text-sm font-medium text-white mb-3"${_scopeId}>Detalles</h4><div class="space-y-2"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><span class="text-sm text-gray-400"${_scopeId}>D\xEDas de crecimiento:</span><span class="text-sm text-white"${_scopeId}>${ssrInterpolate(crop.value.growthDays)} d\xEDas</span></div><div class="flex items-center justify-between"${_scopeId}><span class="text-sm text-gray-400"${_scopeId}>Temporada:</span><span class="text-sm text-white"${_scopeId}>${ssrInterpolate(crop.value.harvestSeason)}</span></div></div></div><div class="border-t border-gray-600 pt-4"${_scopeId}><h4 class="text-sm font-medium text-white mb-3"${_scopeId}>Ayuda</h4><div class="bg-blue-900/20 border border-blue-500/30 rounded-lg p-3"${_scopeId}><p class="text-xs text-blue-300"${_scopeId}><strong${_scopeId}>Tip:</strong> La humedad m\xEDnima debe ser menor que la m\xE1xima. Ajusta estos valores seg\xFAn las necesidades espec\xEDficas de tu cultivo. </p></div></div></div>`);
            } else {
              return [
                createVNode("div", { class: "space-y-4" }, [
                  createVNode("div", null, [
                    createVNode("h4", { class: "text-sm font-medium text-white mb-3" }, "Estado Actual"),
                    createVNode("div", { class: "space-y-2" }, [
                      createVNode("div", { class: "flex items-center justify-between" }, [
                        createVNode("span", { class: "text-sm text-gray-400" }, "Seleccionado:"),
                        createVNode("span", {
                          class: crop.value.isSelected ? "text-green-400" : "text-gray-400"
                        }, toDisplayString(crop.value.isSelected ? "S\xED" : "No"), 3)
                      ]),
                      createVNode("div", { class: "flex items-center justify-between" }, [
                        createVNode("span", { class: "text-sm text-gray-400" }, "Bomba de agua:"),
                        createVNode("span", {
                          class: crop.value.waterPumpActive ? "text-blue-400" : "text-gray-400"
                        }, toDisplayString(crop.value.waterPumpActive ? "Activa" : "Inactiva"), 3)
                      ])
                    ])
                  ]),
                  createVNode("div", { class: "border-t border-gray-600 pt-4" }, [
                    createVNode("h4", { class: "text-sm font-medium text-white mb-3" }, "Detalles"),
                    createVNode("div", { class: "space-y-2" }, [
                      createVNode("div", { class: "flex items-center justify-between" }, [
                        createVNode("span", { class: "text-sm text-gray-400" }, "D\xEDas de crecimiento:"),
                        createVNode("span", { class: "text-sm text-white" }, toDisplayString(crop.value.growthDays) + " d\xEDas", 1)
                      ]),
                      createVNode("div", { class: "flex items-center justify-between" }, [
                        createVNode("span", { class: "text-sm text-gray-400" }, "Temporada:"),
                        createVNode("span", { class: "text-sm text-white" }, toDisplayString(crop.value.harvestSeason), 1)
                      ])
                    ])
                  ]),
                  createVNode("div", { class: "border-t border-gray-600 pt-4" }, [
                    createVNode("h4", { class: "text-sm font-medium text-white mb-3" }, "Ayuda"),
                    createVNode("div", { class: "bg-blue-900/20 border border-blue-500/30 rounded-lg p-3" }, [
                      createVNode("p", { class: "text-xs text-blue-300" }, [
                        createVNode("strong", null, "Tip:"),
                        createTextVNode(" La humedad m\xEDnima debe ser menor que la m\xE1xima. Ajusta estos valores seg\xFAn las necesidades espec\xEDficas de tu cultivo. ")
                      ])
                    ])
                  ])
                ])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/cultivos/editar/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-BbnvRfkb.mjs.map
