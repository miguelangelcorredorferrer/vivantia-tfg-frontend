...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "f5317fff-3ba9-4e6a-9ccd-e344f72e9d6d",
...
const _W9xQDO = defineCachedEventHandler(async (event) => {
...
const _EcmgLU = lazyEventHandler(() => {
...
const _lazy_dZb773 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_dZb773, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _W9xQDO, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _EcmgLU, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_dZb773, lazy: true, middleware: false, method: undefined }
];
