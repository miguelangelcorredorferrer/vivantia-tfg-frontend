<template>
  <div class="space-y-6">
    <div class="mb-8">
      ...
      <p class="text-gray-400 mt-2">Ajustes y configuración del sistema</p>
    </div>
    ...
    <div class="bg-dark-card rounded-lg shadow-lg p-6 border border-gray-600">
      <div class="text-center py-12">
        ...
        <h3 class="mt-2 text-sm font-medium text-white">Configuración del Sistema</h3>
        <p class="mt-1 text-sm text-gray-400">Personaliza y configura tu dashboard</p>
      </div>
    </div>
  </div>
</template>
